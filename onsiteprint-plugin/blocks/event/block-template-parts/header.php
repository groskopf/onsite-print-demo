    ...
    <div class="op-participant-col-info">
        ...
        <div class="op-dropdown-menu" data-dropdown-direction="right">
            ...
            <div class="op-dropdown">
                ...
                <button name="print-all" type="button" class="op-button op-button-size-small op-button-style-outline" data-color="accent-60" data-icon="print" data-icon-position="left">
