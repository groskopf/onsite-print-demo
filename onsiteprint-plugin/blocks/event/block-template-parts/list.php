 ...
 *  Block Part Name: List
 ?  Updated: 2025-12-14 - 05:12 (Y:m:d - H:i)
 ?  Info: Added new Div Elements.
---------------------------------------------------------------------------
 #  The Block Part Content
--------------------------------------------------------------------------- */
?>

<div class="op-participant-list op-flex-col">

    <div class="op-participant-templates op-flex-col">
    ...
    </div><!-- .op-participant-templates -->

    <div class="op-participant-rows op-flex-col"></div><!-- .op-participant-rows -->

</div><!-- .op-participant-list -->