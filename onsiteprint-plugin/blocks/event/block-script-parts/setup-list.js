...
export function opSetupList( debug, block ) {
    ...
    try {
        ...
        for( let i = 0; i < participantList.length; ++i ) {
            ...
            opAddParticipant( debug, block, participantListElement, participantList[i], columnAmount )

            /* opAddEventParticipant( debug, block, participantList[i], columnAmount ).then( response => {
