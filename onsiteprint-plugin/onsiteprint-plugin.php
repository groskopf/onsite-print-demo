 ...
 *	Version: 1.2.6
 ...
 ?  Updated: 2026-31-07 - 03:13 (Y:m:d - H:i)
...
function onsiteprint_acf_init()
{
	if ( function_exists( 'acf_register_block_type' ) ) {
		...
		acf_register_block_type( array(
			...
			'description'		=> __( 'Displaying a Button with a Custom Link.', 'onsiteprint-blocks' ),
		...
		acf_register_block_type( array(
			...
			'description'		=> __( 'Displaying a Toggle Button. Adding an Additional Data Attribute to the parent or sibling element.', 'onsiteprint-blocks' ),
		...
		acf_register_block_type( array(
			...
			'description'		=> __( 'Displaying Booking Information, if the User is logged in.', 'onsiteprint-blocks' ),
		...
		acf_register_block_type( array(
			...
			'description'		=> __( 'Displaying Printer Information, if the User is logged in.', 'onsiteprint-blocks' ),
		...
		acf_register_block_type( array(
			...
			'description'		=> __( 'Displaying Event Information of the current Event, if the User is logged in.', 'onsiteprint-blocks' ),
		...
		acf_register_block_type( array(
			...
			'description'		=> __( 'Displaying Event Template Information of the current Event, if the User is logged in.', 'onsiteprint-blocks' ),
