 var DataGridXL = function () {
     ...
     U.prototype.isOpen = function () {
         ...
         a += "</ul>", J.call(this, window, i, o), this._domNodes.containerNode.innerHTML = a, this._domNodes.containerNode.style.display = "block", this.setCursor(-1), "_mouseDownListener" in this._domNodes.containerNode || (this._domNodes.containerNode._mouseDownListener = function (t) {
     ...
     function Ee() {
         return {
             ...
             children: [Zt.call(this), Jt.call(this), Qt.call(this), ee.call(this), ie.call(this), oe.call(this), se.call(this), ne.call(this), _e.call(this), ye.call(this), xe.call(this), de.call(this), me.call(this), pe.call(this), Ae.call(this), be.call(this), Se.call(this), Ie.call(this), Le.call(this), He.call(this), ze.call(this), Ne.call(this), Fe.call(this)]
         }
     }
     ...
     function $i(t) {
         t.preventDefault(), this.allowPaste && Ji.call(this, t)
     }
     var Ji = function (t) {
     ...
     var ss, ns = (ss = function (t) {
         ...
         move: function (t) {
             ...
             ss.call(this, t), requestAnimationFrame((function () {
                 Jo.call(e, t.ghostPositionPx), es.call(e, t.endCoord)
             }))
         },
         end: function (t) {
         ...
         prepare: function (t) {
             ...
             i -= this.getRowPositionInViewport(t.coords.y), (this._panesYids.top.length || null == this._freezeLineRowAfterId) && (i += 6), t.pointerOffset = i, ss.call(this, t), requestAnimationFrame((function () {
                 Qo.call(e, t.ghostPositionPx), is.call(e, t.coords.y)
             }))
         },
         release: function (t) {
             var e = this;
     ...
     var rn = function (t, e, i) {
         ...
         ln = function (t, e, i) {
             this._domNodes.display[t + "EndFunc"] = function (e) {
                 Qs.call(this, t), Hs[t].handler.release.call(this, this._domNodes.display[t + "Properties"]), this._domNodes.display[t + "Flags"].hasMoved && Hs[t].handler.end.call(this, this._domNodes.display[t + "Properties"]), delete this._domNodes.display[t + "Properties"]
             }.bind(this)
         };
     ...
     function tr() {
         ...
         if (this._selection.length && !this._domNodes.cellEditor._isOpen) {
             var e = Jn(this._cellCursorPosition),
                 i = Vi.call(this, e),
             ...
             if (null != e) {
                 ...
                 t.style.transform = s, t.style.width = i.x.size + "px", t.style.height = i.y.size + "px", Qn.call(this, this._cellCursorPosition) ? this._domNodes.cellCursor.style.opacity = this._domNodes.cellCursor._opacity : this._domNodes.cellCursor.style.opacity = 0
             } else t.style.opacity = 0
         } else t.style.opacity = 0
     }
     ...
     function er() {
         ...
         if (this._searchCellsFound.length) {
             ...
             if (null != i) {
                 ...
                 t.style.transform = n, t.style.width = o.x.size + 4 + "px", t.style.height = o.y.size + 4 + "px", Qn.call(this, i[0]) ? this._domNodes.searchCursor.style.opacity = this._domNodes.searchCursor._opacity : this._domNodes.searchCursor.style.opacity = 0
             } else t.style.opacity = 0
         } else t.style.opacity = 0
     }
     ...
     function vr() {
         ...
         if (this._selection.length && !this._domNodes.cellEditor._isOpen) {
             ...
             t.style.transform = "translate(" + s + "px, " + n + "px)", !Qn.call(this, e) || String(this._currentDragAction).startsWith("select") ? t.style.opacity = 0 : t.style.opacity = this._domNodes.fillHandle._opacity
         } else t.style.opacity = 0
     }
     ...
     function Hr(t, e) {
         ...
         void 0 === t && (t = null), void 0 === e && (e = {}), this._container = t, this._componentIndex = this.constructor.instances.length, b.call(this, e), "loading" == document.readyState ? document.addEventListener("DOMContentLoaded", (function () {
             Q.call(i)
         })) : Q.call(this), "complete" == document.readyState ? (Xt.call(this), Pr.call(this)) : window.addEventListener("load", (function () {
             Xt.call(i), Pr.call(i)
     ...
     var qr = function (t) {
         ...
         Jr = ["searchBar"],
         Qr = ["fullscreenButton", "inputBar", "credits"];
     ...
     function Dl(t) {
         ...
         if (void 0 === t && (t = ""), w.call(this), x.call(this), t.endsWith("Cols"))
             for (var i = 0; i < this._cols.indexList.length; i++) {
                 ...
                 this._columnNodes[o - 1].columnHeaderLabel.innerHTML = Qe.call(this, o)
             }
         var s = !1,
             n = !1;
     ...
     function Ql(t, e, i, o) {
         ...
         if (this.events.dispatch("beforeinsertcols", s)) {
             ...
             }), s.insertedIds = Jl(r), this.events.dispatch("insertcols", s)
         }
     }
     ...
     function Ah(t, e, i, o) {
         ...
         if (this.events.dispatch("beforeinsertrows", s)) {
             ...
             }), s.insertedIds = Jl(r), this.events.dispatch("insertrows", s)
         }
     }
         ...
         if (e.useColTitles)
             for (var s = 0; s < this._rows.coordList.length; s++) {
                 ...
                 for (var n = 0; n < this._cols.coordList.length; n++) {
                     ...
                     var r = Qe.call(this, this._cols.coordList[n]),
     ...
     return Gc.prototype.clearCellValues = function (t) {
     ...
     }, Gc._domNodes = {}, Gc.instances = [], Gc._isIE = function () {
         ...
         return !1
     }(), Gc._isMacOS = navigator.platform.indexOf("Mac") > -1, Gc._isIOS = !!navigator.platform && /iPad|iPhone|iPod/.test(navigator.platform) || "MacIntel" === navigator.platform && navigator.maxTouchPoints > 1, Gc._isTouchDevice = window.matchMedia("(pointer: coarse)").matches, Gc.createEmptyData = function (t, e) {
         for (var i = [], o = 0; o < t; o++) {
             i.push([]);
