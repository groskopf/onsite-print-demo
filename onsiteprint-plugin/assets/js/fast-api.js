...
async function getAuthorization() {
    ...
    ///// The URL to the API.
    let url = `${ getCurrentScriptPath() }/../api/api-get-authorization.php`
...
async function convertCsvIntoJson( formData, validationElement ) {
    ...
    ///// The URL to the API.
    let url = `${ getCurrentScriptPath() }/../api/api-convert-csv-into-json.php`   
...
async function convertGridDataIntoJson( formData, validationElement ) {
    ...
    ///// The URL to the API.
    let url = `${ getCurrentScriptPath() }/../api/api-convert-grid-data-into-json.php`   
